...
## Browser behaviour, layout, and accessibility
  ...
  * For new or changed styles, prefer CSS logical properties and direction-relative values for layouts following content direction, even in single-language projects, subject to browser-support policy. Declare language and direction in HTML; isolate mixed-direction dynamic text where needed. Do not mechanically replace intentional physical directions or assume these defaults prove complete RTL support.
